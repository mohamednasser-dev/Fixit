...
Route::group([
    ...
    Route::post('login/{lang}/{v}', 'TechnicianController@login')->middleware('checkguest');
    Route::get('select_my_data/{lang}/{v}', 'TechnicianController@select_my_data');
    Route::get('my_orders/{lang}/{v}', 'TechnicianController@my_orders');
    Route::get('order/{order_id}/{status}/{lang}/{v}', 'TechnicianController@change_order_status');
