...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2021 at 01:40 AM
...
(50, '012254666', 'ksksdlssklsjdlshklss', 1, '2021-10-02 11:18:48', '2021-11-01 09:28:10');
...
(258, '2021_10_11_104003_update_product_login_table', 22);
...
CREATE TABLE `orders` (
  ...
  `area_id` bigint(11) UNSIGNED NOT NULL,
...
INSERT INTO `orders` (`id`, `product_id`, `user_id`, `price`, `visit_time`, `visit_date`, `status`, `created_at`, `updated_at`, `city_id`, `area_id`, `latitude`, `longitude`) VALUES
(1, 92, 111, 200, '21:00:00', '2021-10-20', 'current', '2021-10-02 16:23:25', '2021-10-02 16:23:25', 0, 0, '', ''),
(2, 92, 111, 200, '21:00:00', '2021-10-20', 'reject', '2021-11-01 11:07:21', '2021-11-01 11:29:52', 0, 0, '', ''),
(3, 92, 111, 200, '21:00:00', '2021-10-20', 'current', '2021-11-01 16:23:25', '2021-11-01 16:23:25', 1, 1, '1234,54', '125,14'),
(4, 92, 111, 200, '21:00:00', '2021-10-20', 'current', '2021-11-01 16:37:17', '2021-11-01 16:37:17', 1, 1, '1234,54', '125,14'),
(5, 92, 111, 200, '21:00:00', '2021-10-20', 'current', '2021-11-01 16:48:14', '2021-11-01 16:48:14', 1, 1, '1234,54', '125,14'),
(6, 92, 111, 200, '21:00:00', '2021-10-20', 'current', '2021-11-01 17:06:10', '2021-11-01 17:06:10', 1, 1, '1234,54', '125,14'),
(7, 92, 111, 200, '21:00:00', '2021-10-20', 'current', '2021-11-01 17:07:08', '2021-11-01 17:07:08', 1, 1, '1234,54', '125,14');
...
INSERT INTO `products` (`id`, `title_ar`, `title_en`, `description_ar`, `description_en`, `price`, `category_id`, `sub_category_id`, `sub_category_two_id`, `sub_category_three_id`, `sub_category_four_id`, `sub_category_five_id`, `main_image`, `user_id`, `type`, `views`, `offer`, `choose_it`, `status`, `deleted`, `publish`, `publication_date`, `expiry_date`, `retweet_date`, `retweet`, `expire_pin_date`, `feature`, `plan_id`, `city_id`, `area_id`, `share_location`, `latitude`, `longitude`, `pin`, `re_post`, `re_post_date`, `is_special`, `expire_special_date`, `created_at`, `updated_at`, `email`, `password`, `phone`) VALUES
(91, 'نادر يوسف', 'nader yosef', 'بشيلبسيليسلبسيلي', 'fdggfgfsdfgfsdg', 200.00, 11, NULL, NULL, NULL, NULL, NULL, 'gus2ae5cibrm40wcdopn.jpg', NULL, 1, 0, 0, 0, 1, 0, 'Y', NULL, NULL, NULL, 0, NULL, 0, NULL, 1, NULL, '1', NULL, NULL, 0, '0', NULL, '0', NULL, '2021-09-27 12:28:43', '2021-09-27 12:28:43', '', '', '01201636129'),
(92, 'احمد علي', 'ahmed ali', 'about about about', '2', 1.00, 11, NULL, NULL, NULL, NULL, NULL, 'kvwo2jiau5mfbrieafbv.jpg', NULL, 1, 0, 0, 0, 1, 0, 'Y', NULL, NULL, NULL, 0, NULL, 0, NULL, 1, NULL, '1', NULL, NULL, 0, '0', NULL, '0', NULL, '2021-10-02 12:11:42', '2021-11-01 10:59:07', 'ali@gmail.com', '$2y$10$589h1mfxtl72CSxOAmjDpeG45ZTzUdkQgucwhxSIcJh/aUT8p/KrK', '01111651415');
...
(5, 92, 15, '2021-11-01 10:02:04', '2021-11-01 10:02:04');
...
--
ALTER TABLE `migrations`
  MODIFY `id` bigint(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=259;
